...
AMovingPlatformV2::AMovingPlatformV2()
{
	...
	UE_LOG(LogTemp, Display, TEXT("BP %s has been initialized"), *Name);
...
void AMovingPlatformV2::Tick(float DeltaTime)
{
	...
	AMovingPlatformV2::MovePlatform(DeltaTime);

	AMovingPlatformV2::RotatePlatform(DeltaTime);
...
void AMovingPlatformV2::MovePlatform(float DeltaTime)
{
...
void AMovingPlatformV2::RotatePlatform(float DeltaTime)
{
